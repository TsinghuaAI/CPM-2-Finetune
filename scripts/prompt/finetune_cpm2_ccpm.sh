...
SAVE_PATH="${WORKING_DIR}/results/ccpm/cpm2_prompt_lr${LR}const_G${GRAD_ACC}_seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_ccpm_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/ccpm/ccpm_10_0_0.json"
